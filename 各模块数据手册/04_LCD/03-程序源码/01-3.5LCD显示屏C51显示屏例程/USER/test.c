...
//测试硬件：单片机STC51,晶振30M  单片机工作电压3.3V
//QDtech-TFT液晶驱动 for C51
//中景园电子
//淘宝网站:https://shop73023976.taobao.com/?spm=2013.1.1000126.d21.o6byVe
...
Gui_StrCenter(0,lcddev.height-18,WHITE,BLUE,"中景园版权所有",16,1);//居中显示
//绘制测试区域
...
void main_test(void)
{
	...
	Gui_StrCenter(0,30,RED,BLUE,"中景园",16,1);//居中显示
	Gui_StrCenter(0,60,RED,BLUE,"中景园综合测试程序",16,1);//居中显示	
	Gui_StrCenter(0,90,YELLOW,BLUE,"3.5' ILI9486 320X480",16,1);//居中显示
	Gui_StrCenter(0,120,BLUE,BLUE,"ZJY 2016-4-17",16,1);//居中显示
	delay_ms(1500);		
	delay_ms(1500);
}
...
{	
	...
	Show_Str(10,50,BLUE,YELLOW,"16X16:Welcome中景园电子",16,1);
	Show_Str(10,70,BLUE,YELLOW,"24X24:中景园中文测试",24,1);
