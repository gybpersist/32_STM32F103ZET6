...
int main()
{
    ...
    Int_NorFlash_WritePageData(0x3F,0x0F,0x00,write_datas,sizeof(write_datas) - 1);
    // 读取数据 (页读取) (每页最大 256 字节)
    Int_NorFlash_ReadPageData(0x3F,0x0F,0x00,0x00,read_datas,sizeof(write_datas) - 1);
