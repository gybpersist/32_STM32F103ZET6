...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  if (htim == &htim6)
  {
    ...
    // 变化占空比
    __HAL_TIM_SET_COMPARE(&htim5,TIM_CHANNEL_1,g_pwm_duty);
    __HAL_TIM_SET_COMPARE(&htim5,TIM_CHANNEL_2,g_pwm_duty);
